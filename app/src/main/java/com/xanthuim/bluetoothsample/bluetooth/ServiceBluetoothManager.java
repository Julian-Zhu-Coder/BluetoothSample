...
/**
 * Created by Xanthium on 2017/3/8.
 */
...
public final class ServiceBluetoothManager extends BluetoothManager
{
    ...
    private ServiceBluetoothManager(Context context, IBluetoothCallback bluetoothCallback)
    {
     ...
     * @return
     */
    public static BluetoothManager getManager(Context context, IBluetoothCallback bluetoothCallback)
    {
